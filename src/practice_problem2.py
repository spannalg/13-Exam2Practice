...
def run_test_practice_problem2a():
    ...
    print('--------------------------------------------------')
    print("Test 1 Expected: [8, 16, 11, -14, 14]")
    print ("test 1 Actual:", practice_problem2a([2, 10, 5, -20, 8],6))
    print("Test 1 Expected: [12, 18, 10, -22, 15]")
    print("test 1 Actual:", practice_problem2a([7, 13, 5, -27, 10], 5))
